...
$lang['unexpected_issues_message'] = 'Não foi possível concluir a operação.';
$lang['close'] = 'Fechar';
...
$lang['secret_header'] = 'Cabeçalho Secreto';
$lang['search'] = 'Pesquisar';
$lang['slot_interval'] = 'Intervalo de Horário (Minutos)';
$lang['jitsi'] = 'Jitsi';
$lang['jitsi_info'] = 'Ativar a geração automática de links de reunião Jitsi para agendamentos. Quando ativado, um link exclusivo de videochamada Jitsi será gerado e armazenado como o link da reunião.';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'ALTCHA é uma alternativa ao CAPTCHA focada em privacidade e de código aberto que usa prova de trabalho para verificar usuários humanos sem rastreamento.';
$lang['altcha_enabled_hint'] = 'Quando ativado, o ALTCHA será usado no lugar do CAPTCHA de imagem tradicional para verificação de formulários.';
...
$lang['altcha_max_number'] = 'Número Máximo';
$lang['altcha_max_number_hint'] = 'O número máximo para o desafio de prova de trabalho. Valores mais altos aumentam a dificuldade (padrão: 100000).';
$lang['altcha_expires'] = 'Expira (Segundos)';
$lang['altcha_expires_hint'] = 'Por quanto tempo um desafio permanece válido em segundos (padrão: 300).';
$lang['altcha_key_generated'] = 'Nova chave HMAC gerada com sucesso.';
$lang['altcha_enabled'] = 'Ativar ALTCHA';
$lang['altcha_captcha_not_active_warning'] = 'A configuração CAPTCHA não está ativa no momento. O ALTCHA não será utilizado a menos que o CAPTCHA esteja ativado nas';
$lang['generate'] = 'Gerar';
$lang['meeting_link'] = 'Link da reunião';
$lang['google_calendar'] = 'Google Agenda';
$lang['google_calendar_info'] = 'Ativar a sincronização com o Google Calendar para sincronizar agendamentos com as contas do Google Calendar dos prestadores.';
$lang['google_client_id'] = 'ID do Cliente';
$lang['google_client_id_info'] = 'O ID do Cliente do seu projeto no Google Cloud Console.';
$lang['google_client_secret'] = 'Segredo do Cliente';
$lang['google_client_secret_info'] = 'O Segredo do Cliente do seu projeto no Google Cloud Console.';
$lang['google_calendar_setup_info'] = 'Para ativar a sincronização com o Google Calendar, você precisa criar um projeto no Google Cloud Console, ativar a API do Google Calendar e criar credenciais OAuth 2.0. Visite:';
$lang['google_meet_link_generation'] = 'Gerar Links do Google Meet';
$lang['google_meet_link_generation_info'] = 'Criar automaticamente um link de videoconferência Google Meet para agendamentos sincronizados. O link da reunião será armazenado no campo de link de reunião do agendamento.';
$lang['display_add_to_google_calendar'] = 'Exibir Botão "Adicionar ao Google Calendar"';
$lang['display_add_to_google_calendar_info'] = 'Mostrar o botão "Adicionar ao Google Calendar" na página de confirmação da reserva, permitindo que os clientes adicionem facilmente o agendamento ao seu Google Calendar pessoal.';
$lang['select_all'] = 'Selecionar tudo';
$lang['select_none'] = 'Desmarcar tudo';
$lang['appointment_update'] = 'Atualização de agendamento';
$lang['notify_users_on_update_question'] = 'Gostaria de enviar uma notificação sobre esta alteração?';
$lang['yes'] = 'Sim';
$lang['no'] = 'Não';
$lang['latest_blog_posts'] = 'Últimas postagens do blog';
$lang['loading'] = 'Carregando';
$lang['blog_posts_load_error'] = 'Não foi possível carregar as postagens do blog. Visite o site oficial para atualizações.';
...
$lang['no_available_service_providers'] = 'Nenhum serviço disponível';
$lang['no_available_service_providers_message'] = 'Atualmente não há serviços ou prestadores disponíveis para agendamento. Por favor, verifique mais tarde ou entre em contato conosco para obter ajuda.';
$lang['reset_password'] = 'Redefinir senha';
$lang['new_password'] = 'Nova senha';
$lang['enter_new_password'] = 'Digite sua nova senha abaixo.';
$lang['enter_password_here'] = 'Digite a senha aqui ...';
$lang['password_reset_request'] = 'Solicitação de redefinição de senha';
...
$lang['type_username_and_email_for_reset_link'] = 'Digite seu nome de usuário e endereço de e-mail para receber um link de redefinição de senha.';
...
$lang['working_plan_validation_failed'] = 'Configuração inválida do plano de trabalho encontrada.';
$lang['start_date'] = 'Data de Início';
$lang['end_date'] = 'Data de Término';
$lang['remember_me'] = 'Lembrar minhas informações';
$lang['remember_me_hint'] = 'Salvar seus dados para uma reserva mais rápida na próxima vez.';
$lang['legal_notice'] = 'Aviso Legal';
$lang['legal_notice_url'] = 'URL do Aviso Legal';
$lang['legal_notice_url_hint'] = 'Insira a URL da sua página de aviso legal.';
$lang['imprint'] = 'Expediente';
$lang['imprint_url'] = 'URL do Expediente';
$lang['imprint_url_hint'] = 'Insira a URL da sua página de expediente.';
$lang['data_retention'] = 'Retenção de Dados';
$lang['data_retention_days'] = 'Dias de Retenção de Dados';
$lang['data_retention_days_hint'] = 'Defina o número de dias após os quais os dados do cliente serão excluídos automaticamente. Defina como 0 para desativar a exclusão automática.';
$lang['manage_privacy'] = 'Gerenciar Privacidade';
$lang['manage_privacy_hint'] = 'Clique no link abaixo para visualizar, atualizar ou excluir suas informações pessoais.';
$lang['personal_information'] = 'Informações Pessoais';
$lang['personal_information_updated'] = 'Suas informações pessoais foram atualizadas com sucesso.';
$lang['verify'] = 'Verificar';
$lang['verifying'] = 'Verificando';
$lang['verified'] = 'Verificado';
$lang['verification_complete'] = 'Verificação concluída';
$lang['verification_failed'] = 'Verificação falhou. Clique para tentar novamente.';
$lang['click_to_verify'] = 'Clique para verificar que você é humano';
$lang['altcha_verification_failed'] = 'Verificação ALTCHA falhou. Por favor, tente novamente.';
$lang['premium'] = 'Premium';
$lang['about_app_premium'] = 'Oferecemos serviços completos para software auto-hospedado, incluindo desenvolvimento personalizado, hospedagem gerenciada, contratos de suporte, personalização de marca e melhorias contínuas — para que você possa focar no seu negócio enquanto nós cuidamos do resto.';
